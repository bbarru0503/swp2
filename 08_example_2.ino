...
void setup() {
  ...
  analogWrite(PIN_LED, 255);  // turn-off LED
...
void loop() { 
  ...
  if (200 >= distance && distance > 100) {
    brightness = 255 - ((distance - 100) * 2.55);
    }
  else if (300 >= distance && distance > 200) {
    brightness = (distance - 200) * 2.55;
    }
  else {
    brightness = 255;
    }
