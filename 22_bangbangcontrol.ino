...
#define _DUTY_MAX 2095 // 2000
#define _DUTY_NEU 1505 // 1500
#define _DUTY_MIN 905 // 1000

#define _SERVO_ANGLE_DIFF  100  // Replace with |D - E| degree
#define _SERVO_SPEED       100  // servo speed

#define _BANGBANG_RANGE    2000  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 423 -1.45*a_value + 1.23E-03*a_value*a_value;
}
